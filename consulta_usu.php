...
<body>
    ...
    <header class="intro-header" style="background-color: #27403D">
        <div class="container">
            <div class="row">
        ...
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                ...
                <?php
                    ...
                    $query = "SELECT * FROM Usuario WHERE idUsuario = '$cod_usu'";
                    $ejecuta = pg_query($conexion, $query);
                    
                    if ($mostrar=pg_fetch_array($ejecuta)) {
                ?>
                <p>Código del usuario: <?php echo $mostrar['idusuario']; ?></p>
                <p>Nombre: <?php echo $mostrar['nombre']; ?></p>
                <p>Contraseña: <?php echo $mostrar['contrasena']; ?></p>
                <br><br>
                <?php
                    } else {
                        echo "No existe";
